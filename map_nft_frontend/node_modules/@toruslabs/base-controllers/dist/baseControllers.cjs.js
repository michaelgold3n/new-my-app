...
/* harmony import */ var bignumber_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11);
...
/* harmony import */ var _toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7);
/* harmony import */ var _toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var eth_rpc_errors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(10);
/* harmony import */ var eth_rpc_errors__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(eth_rpc_errors__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var json_rpc_random_id__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(36);
...
function providerFromEngine(engine) {
  ...
  provider.sendAsync = async req => {
    ...
    if (res.error) {
      ...
      const err = Object(eth_rpc_errors__WEBPACK_IMPORTED_MODULE_2__["serializeError"])(res.error, {
        fallbackError: {
...
/* harmony import */ var _toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7);
/* harmony import */ var _toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var eth_rpc_errors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10);
...
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _toruslabs_http_helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);
...
class BasePreferencesController extends _BaseController__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"] {
  ...
  async getDappList() {
    try {
      const response = await Object(_toruslabs_http_helpers__WEBPACK_IMPORTED_MODULE_1__["get"])("".concat(this.config.api, "/dapps"), this.headers(), {
        useAPIKey: true
      });
      return response.success ? response.data : [];
    } catch (error) {
...
/* harmony import */ var _ITransactionController__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5);
...
// EXTERNAL MODULE: external "@toruslabs/broadcast-channel"
var broadcast_channel_ = __webpack_require__(8);
...
class BroadcastChannelHandler_BroadcastChannelHandler {
  constructor(channelPrefix) {
    ...
    this.bc = new broadcast_channel_["BroadcastChannel"](this.channel, utils["c" /* broadcastChannelOptions */]);
  }
  ...
  async open() {
    return new Promise((resolve, reject) => {
      ...
      if (!this.state.windowId) {
        ...
        const bc = new broadcast_channel_["BroadcastChannel"](this.state.windowId, utils["c" /* broadcastChannelOptions */]);
...
class PopupStoreChannel_PopupStoreChannel {
  ...
  logoutChannel() {
    const logoutChannel = new broadcast_channel_["BroadcastChannel"]("".concat(enums["n" /* BROADCAST_CHANNELS */].WALLET_LOGOUT_CHANNEL, "_").concat(this.instanceId), utils["c" /* broadcastChannelOptions */]);
  ...
  importAccountChannel() {
    const walletAccountImportChannel = new broadcast_channel_["BroadcastChannel"]("".concat(enums["n" /* BROADCAST_CHANNELS */].WALLET_ACCOUNT_IMPORT_CHANNEL, "_").concat(this.instanceId), utils["c" /* broadcastChannelOptions */]);
  ...
  networkChangeChannel() {
    const walletAccountImportChannel = new broadcast_channel_["BroadcastChannel"]("".concat(enums["n" /* BROADCAST_CHANNELS */].WALLET_NETWORK_CHANGE_CHANNEL, "_").concat(this.instanceId), utils["c" /* broadcastChannelOptions */]);
    walletAccountImportChannel.addEventListener("message", ev => {
      var _ev$data4;
  ...
  selectedAddressChangeChannel() {
    const walletAccountImportChannel = new broadcast_channel_["BroadcastChannel"]("".concat(enums["n" /* BROADCAST_CHANNELS */].WALLET_SELECTED_ADDRESS_CHANNEL, "_").concat(this.instanceId), utils["c" /* broadcastChannelOptions */]);
    walletAccountImportChannel.addEventListener("message", ev => {
      var _ev$data6;
...
class PopupWithBcHandler_PopupWithBcHandler extends Popup_PopupHandler {
  constructor(_ref) {
    ...
    this.bc = new broadcast_channel_["BroadcastChannel"](instanceId, utils["c" /* broadcastChannelOptions */]);
  }
  /**
...
// EXTERNAL MODULE: ./src/utils/utils.ts
var utils_utils = __webpack_require__(12);
    ...
    return new Promise((resolve, reject) => {
      ...
      try {
        if (!finalQueryParams.windowId) {
          bc = new broadcast_channel_["BroadcastChannel"]("".concat(enums["n" /* BROADCAST_CHANNELS */].REDIRECT_CHANNEL, "_").concat(instanceParameters.instanceId), utils_utils["c" /* broadcastChannelOptions */]);
          bc.addEventListener("message", async ev => {
            if (ev.error) {
              reject(ev.error);
              window.close();
          ...
          bc = new broadcast_channel_["BroadcastChannel"]("".concat(finalQueryParams.windowId), utils_utils["c" /* broadcastChannelOptions */]);
          bc.addEventListener("message", async ev => {
            const {
              url,
              message
...
/* harmony import */ var _Transaction_ITransactionController__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(5);
